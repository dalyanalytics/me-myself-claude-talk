...
::: {.notes}
This is actual code from the MTM data orchestration system. Look at what's happening here:
...
<div style="display: flex; justify-content: center; align-items: center; gap: 15px; margin: 20px auto; max-width: 100%; flex-wrap: wrap;">

<div style="background: #D68A93; padding: 12px 15px; border-radius: 8px; flex: 1; min-width: 140px; max-width: 160px; text-align: center; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
<div style="font-size: 0.95em; font-weight: bold; color: white; line-height: 1.2;">1. Understand<br>Requirements</div>
<div style="font-size: 0.75em; color: white; margin-top: 5px;">Human</div>
</div>

<div style="font-size: 2em; color: #F9B397; font-weight: bold;">→</div>

<div style="background: #6A94C9; padding: 12px 15px; border-radius: 8px; flex: 1; min-width: 140px; max-width: 160px; text-align: center; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
<div style="font-size: 0.95em; font-weight: bold; color: white; line-height: 1.2;">2. Generate<br>Implementation</div>
<div style="font-size: 0.75em; color: white; margin-top: 5px;">Claude Code</div>
</div>

<div style="font-size: 2em; color: #F9B397; font-weight: bold;">→</div>

<div style="background: #AD92B1; padding: 12px 15px; border-radius: 8px; flex: 1; min-width: 140px; max-width: 160px; text-align: center; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
<div style="font-size: 0.95em; font-weight: bold; color: white; line-height: 1.2;">3. Review &<br>Course-Correct</div>
<div style="font-size: 0.75em; color: white; margin-top: 5px;">Human</div>
</div>
...
<div style="background: #6A94C9; padding: 12px 15px; border-radius: 8px; flex: 1; min-width: 140px; max-width: 160px; text-align: center; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
<div style="font-size: 0.95em; font-weight: bold; color: white; line-height: 1.2;">4. Iterate<br>Based on Feedback</div>
<div style="font-size: 0.75em; color: white; margin-top: 5px;">Claude Code</div>
</div>
...
<div style="background: #D68A93; padding: 12px 15px; border-radius: 8px; flex: 1; min-width: 140px; max-width: 160px; text-align: center; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
<div style="font-size: 0.95em; font-weight: bold; color: white; line-height: 1.2;">5. Final QA<br>& Delivery</div>
<div style="font-size: 0.75em; color: white; margin-top: 5px;">Human</div>
</div>
...
**Documentation agent:** Analyzes your code and generates comprehensive documentation—not just function signatures, but usage examples and explanations.

**Deployment agent:** Handles the DevOps work—writing Dockerfiles, setting up CI/CD pipelines, managing infrastructure as code.

**Code review agent:** Acts like a senior developer reviewing your code—catches potential bugs, suggests performance improvements, identifies security issues.
...
**The caveat:** I'm still exploring this. The human-in-the-loop principle remains—you're still the manager, making strategic decisions and ensuring quality. But the AI team gets more capable.

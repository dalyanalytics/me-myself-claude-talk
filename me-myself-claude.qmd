...
::: {.notes}
To level-set everyone and provide some context: I'm a mom of 2 young kids with limited time resources. I'm also an active Volunteer in my community.
...
::: {.notes}
This time last year, November 2024, I was laser focused on client delivery, which was an estimated 85% of my time writing code. And I loved spending all my time in R, fighting bugs, researching solutions on stackoverflow and forums and straightup delivering value for my client. Emphasis on the singular client at one time, which totally enables you to fully entrench yourself in their code base and systems. As a new consultant that makes sense, but that math starts to break when you remove your "dev hat" and put on your "bizdev hat" and you need to start taking proactive steps to growing and scaling your business. When you are solo you need to be extra cautious about where to spend your time.
:::
...
::: {.notes}
- Previously: 85% client development, 15% business development
- Now: 70% client development, 25% business development, 5% Community Contributions 
:::
...
## Example 2: The {avilistr} Package {.smaller}

...
- **Claude is my senior developer partner**: Implementing solutions, handling boilerplate code
- **Human in/on the loop**: Active technical leadership stays with me!
:::

::: {.fragment}
With more help from Claude I get to **amplify my capacity** to take on bigger, more interesting problems.
:::
...
::: {.fragment}
**Enterprise-grade infrastructure built in days with Claude's help. I own the architecture.**
:::

...
One of the key takeaways of this entire talk is to reframe our language around how we talk about AI-assisted coding. "Vibe Coding" - while often a funny phrase - really diminishes our impact and the capacity for others to understand our lived experience as software developers.
...
**Before AI:** 85% of my mental energy and time went to client development work. That's writing code, debugging, implementing features, wrestling with syntax. Only 15% went to business development—proposals, networking, marketing, financial planning. There was no room for anything else.
...
**The Reallocation:** That 15% didn't disappear—it got redistributed:
...
This slide sets up everything that follows in the talk—all four parts are enabled by this fundamental reallocation of cognitive capacity.
:::
...
::: {.notes}
This is the core philosophy that drives everything in Part 2. I'm running a solo consultancy, and I could optimize for different things—maximum revenue, maximum number of clients, or rapid business growth. But that's not what I'm after.

**The Venn Diagram:** Professional joy sits at the intersection of four overlapping areas:

**Client Work (Blue):** Values-aligned clients—nonprofits, social impact organizations, NGOs. These are organizations doing important work in the world, often with limited resources. High personal interaction and deep relationships, not transactional projects. Quality over quantity—I'd rather work with 5 clients I'm deeply invested in than 20 clients where I'm just checking boxes.

**Technical Growth (Purple):** Challenging problems that expand my R expertise. Working on problems that challenge me technically—learning new packages, exploring new approaches, building expertise in data engineering, automation, and infrastructure. This keeps the work interesting and valuable.

**Community (Pink):** Professional development through community engagement—speaking at conferences like this one, contributing open source packages ({shinyfa}, {avilistr}), participating in the R community, continuous learning. These activities don't directly generate revenue, but they're essential to professional satisfaction and long-term growth.

**Life Balance (Orange):** Not sacrificing home life for business growth. I'm a solo consultant, not a startup founder trying to build a unicorn. I have a life outside of work that matters—family, hobbies, health. Sustainable consulting means not burning out.
...
**The AI Advantage:** Here's where AI becomes transformative. It doesn't just save me time—it gives me the capacity to be *selective*. I can say YES to the projects that bring professional joy and NO to the ones that don't, because AI assistance means I'm not constantly capacity-constrained. I can take on challenging technical problems without sacrificing quality or work-life balance.

This philosophy sets up everything that follows in Part 2. The technical skills and workflows I'm about to share aren't about doing more work—they're about doing the *right* work, with the *right* clients, in a way that's sustainable and joyful.
:::
...
**Be Specific with Requirements:** Vague instructions get vague results. "Add error handling" → "Add tryCatch with informative error messages for API failures." "Make it faster" → "Use data.table instead of dplyr for this 1M+ row operation."
...
This model lets you say YES to bigger projects while maintaining the quality and technical ownership that makes you valuable to clients. Claude is a tool and partner—you're still the expert leading the work.
:::
...
**The Key Insight:** I didn't need to memorize GitHub Actions syntax. I needed to understand the architecture—what needs to happen, when, and why. Claude Code handled translating that understanding into correct YAML.
...
**1. Understand Requirements (Human):** I talk to the client, understand their business problem, and translate that into technical requirements. This is where domain expertise matters—knowing what questions to ask, understanding their constraints.
...
**5. Final QA & Delivery (Human):** I test everything thoroughly, write documentation, and deliver to the client. This is where my reputation is on the line—the final quality check is always human.
...
::: {.notes}
This is the key insight that ties together everything in Part 2. AI-assisted development hasn't made me lazy or dependent—it's made me MORE focused on what actually matters to my clients.
...
**Professional Joy Connection:** This ties back to the "Optimizing for Professional Joy" slide. Being ruthlessly solutions-focused is WHY I find this work satisfying. I'm helping nonprofits and social impact organizations solve real problems, not just writing code. AI assistance lets me operate at the level where I'm most valuable—strategic thinking and client partnership, not syntax wrangling.

**The Technical Skills Still Matter:** To be clear, I still need deep R expertise. But that expertise is now deployed strategically—reviewing Claude's code, making architectural decisions, ensuring quality—rather than being consumed by basic implementation. This is a elevation of how I use my skills, not a replacement of them.
...
::: {.notes}
This is the fundamental shift in how I learn R now. It's not about replacing deep learning—it's about encountering more patterns, more errors, and more solutions in the same amount of time.
...
This isn't about becoming dependent on AI—it's about using AI to accelerate the learning process by increasing your exposure to different R patterns and approaches.
:::
...
But here's the key insight: **this happens with mature packages too.** Even with {ggplot2}, Claude will confuse function arguments, mix up geom parameters, or suggest deprecated approaches. It's not just "new packages are risky"—Claude can hallucinate about ANY package if it doesn't have current context.

**Why does this happen to humans?** You're really experienced. You've used hundreds of R packages. You're busy. You think "Hey, I'm good at this, this other thing should come really easy." So you circumvent the fundamentals—you skip the vignette, skim the examples, and start coding. Then you hit errors because you assumed instead of verified.
...
**The skill you build:** Systematic verification. Don't assume—verify. This applies whether you're using AI or coding yourself.
:::
...
**Learning at Scale:** The volume advantage means you encounter these mistake patterns FASTER than traditional development. Instead of one careful implementation per week, you see 10 attempts per day. Each failure refines your prompting skills AND your R intuition. You're not becoming dependent—you're becoming a better technical leader who knows how to redirect when things go wrong.
...
**Research & Analysis:** In Part 3, we've covered how to learn from Claude's mistakes—package confusion, data assumptions, over-abstraction. This is the research and analysis phase. You're not just fixing errors; you're understanding WHY they happen and what patterns they reveal about effective R development.
...
**Personal Growth & Overcoming Challenges:** The discipline of the practice is staying engaged when Claude makes mistakes, not giving up when errors repeat, maintaining curiosity about WHY something failed rather than just fixing it. The temptation with AI is to become passive—just accept what it generates. The art of the practice is staying active, critical, and intentional.
...
This is systematic skill development—using AI as a tool to practice more, fail faster, and learn deeper. The art is in how you engage with the process, not just the output you produce.
:::
...
::: {.notes}
The relationship with Claude is both IN the loop and ON the loop. Integrated and Supervisory. In the weeds and yet at the 10,000 foot view.

Before you start working with AI tools like Claude Code, take time to establish your personal values and boundaries. This isn't about restricting AI use—it's about using it intentionally.
